...
/**
 * Header Component
 * Renders a sticky top navigation bar using backdrop-blur for glassmorphism.
 * Includes clinic branding with interactive logo animation on hover (scale up)
 * and a prominent click-to-call CTA button on the right.
 */
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-brand-cream/80 backdrop-blur-md border-b border-brand-blush/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        {/* Logo and Branding: Scale animation on hover */}
        <a href="#" className="flex items-center gap-2 group" aria-label="Vatsalya Clinic Home">
        ...
        {/* Sticky CTA Phone Button: Changes background color on hover */}
        <a
